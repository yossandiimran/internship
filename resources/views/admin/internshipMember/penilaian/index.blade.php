                ...
                <form id="form-data" method="post" action="{{ route('admin.master.divisi.store') }}">
                    ...
                    <div class="modal-body" id="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="divisi" class="form-control" id="divisi-form"
                                placeholder="Masukan divisi" required />
                        </div>
                        <div class="form-group">
                            <label for="lokasi-form">Lokasi</label>
                            <input type="text" name="lokasi" class="form-control" id="lokasi-form"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            dt = $("#table-data").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.internshipMember.penilaian.scopeData') }}",
                    type: "post"
                },
                columns: [{
                        data: "DT_RowIndex",
